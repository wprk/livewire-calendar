...
![preview](https://github.com/wprk/livewire-calendar/raw/master/preview.gif)
...
In the `Calendar` class, instead of extending from the base `Component` Livewire class, 
...
![example](https://github.com/wprk/livewire-calendar/raw/master/example.png)
...
- [Will Parker](https://github.com/wprk)
